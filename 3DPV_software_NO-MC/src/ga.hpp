...
class GA 
{
 ...
 public:
  ...
  bool generate(double best_parray[], int a_factor, int *my_gen_curr);
  bool nsgaGenerate(double best_parray[], int a_factor, double best_oarray0[], double best_oarray1[], int *my_gen_curr);
