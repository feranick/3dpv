#!/usr/bin/perl
# Usage: perl ./color-scale.pl structurefile.txt powerfile.txt time framenumber
...
print OUT "t" ."$j = Graphics3D[{Opacity[@power[$j]],Red,{EdgeForm[Thick],Polygon[{{$v1,$v2,$v3},{$v4,$v5,$v6},{$v7,$v8,$v9}}]}},Boxed->False];\n" ;
